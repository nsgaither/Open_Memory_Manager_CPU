...
defines:
	...
	$(file >>src/generated_defines.svh,`define ${PAD_DEFINE})
	$(file >>src/generated_defines.svh,`define ${SCL_DEFINE})
.PHONY: defines
...
test-mem512x32: ## Run mem512x32 cocotb testbench
	cd cocotb; PDK_ROOT=${PDK_ROOT} PDK=${PDK} SLOT=${SLOT} python3 mem512x32_tb.py
.PHONY: test-mem512x32
