...
def chip_top_runner():
    ...
    if gl:
        ...
        sources.append(proj_path / "../src/cache_controller/outbound_arbiter.sv")
        sources.append(proj_path / "../src/cache_controller/on_snoop_event_state_machine.sv")
        sources.append(proj_path / "../src/cache_controller/on_processor_event_state_machine.sv")
        sources.append(proj_path / "../src/cache_controller/apply_wstrb.sv")
        sources.append(proj_path / "../src/mem_ctrl/two_port_cache_mem.sv")
